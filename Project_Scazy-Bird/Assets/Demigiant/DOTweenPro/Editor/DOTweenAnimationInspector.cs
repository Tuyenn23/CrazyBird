        ...
        override public void OnInspectorGUI()
        {
            ...
            if (playMode) {
                if (_runtimeEditMode) {
                    ...
                    if (GUILayout.Button(new GUIContent("Activate Edit PlayMode", "Switches to Runtime Edit PlayMode, where you can change animations values and restart them"))) {
...
//            _src.isValid = Validate(); // Moved down
            ...
            if (playMode) {
                GUILayout.Space(4);
                DeGUILayout.Toolbar("Edit PlayMode Commands");
...
//                _src.animationType = (DOTweenAnimation.AnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
                ...
                case DOTweenAnimation.AnimationType.LocalRotate:
                    ...
                    if (isRigidbody2D) GUIEndValueFloat();
                        ...
                        _src.optionalRotationMode = (RotateMode)EditorGUILayout.EnumPopup("    Rotation PlayMode", _src.optionalRotationMode);
                    }
                    break;
                case DOTweenAnimation.AnimationType.Scale:
                ...
                case DOTweenAnimation.AnimationType.Text:
                    ...
                    _src.optionalScrambleMode = (ScrambleMode)EditorGUILayout.EnumPopup("Scramble PlayMode", _src.optionalScrambleMode);
